...
{
    public class SKNF : INormalizationForm
    {
        public string GetNormalForm(ArgValuePair[] table)
        {
            ...
            {
                //пропускаем итерацию, если при текущем наборе функция = 1
                if (table[i].value == 1)
                    continue;
            ...
            if (expression.Count > 0)
                ...
                throw new ArgumentException("Функция задана неверно. Возможно отсутствуют значения 0");
        }
    }
}
